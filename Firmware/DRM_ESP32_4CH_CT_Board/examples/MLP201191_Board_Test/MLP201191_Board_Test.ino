/***************************************************************************************************************************/
/*
    A library test using MLP201191 ESP32 S2 4-Channel CT Sensor Board
...
// library for the ESP32 S2 (13-bit A/D)
#define AD_1 1          // GPIO pin for A/D input channel 1
#define AD_2 2          // GPIO pin for A/D input channel 2
#define AD_3 3          // GPIO pin for A/D input channel 3
#define AD_4 4          // GPIO pin for A/D input channel 4
...
void setup() {
   ...
   //uncomment to set the resolution to 12 bits (0-4096)
